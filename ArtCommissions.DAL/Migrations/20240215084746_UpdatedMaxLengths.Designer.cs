...
namespace ArtCommissions.DAL.Migrations
{
    ...
    [Migration("20240215084746_UpdatedMaxLengths")]
    partial class UpdatedMaxLengths
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArtCommissions.DAL.Entities.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArtCommissions.DAL.Entities.CommissionReport", b =>
                {
                    b.HasOne("ArtCommissions.DAL.Entities.Report", "Report")
                        .WithOne()
                        .HasForeignKey("ArtCommissions.DAL.Entities.CommissionReport", "ReportId")
            ...
            modelBuilder.Entity("ArtCommissions.DAL.Entities.UserReport", b =>
                {
                    b.HasOne("ArtCommissions.DAL.Entities.Report", "Report")
                        .WithOne()
                        .HasForeignKey("ArtCommissions.DAL.Entities.UserReport", "ReportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
