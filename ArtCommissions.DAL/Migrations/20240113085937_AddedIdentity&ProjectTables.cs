...
{
    /// <inheritdoc />
    public partial class AddedIdentityProjectTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Commissions_AppUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommissionSampleImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommissionSampleImages_Commissions_CommissionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reviews", x => new { x.ReviewerId, x.CommissionId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Commissions_OwnerId",
                table: "Commissions",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_CommissionSampleImages_CommissionId",
